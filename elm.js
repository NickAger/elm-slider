...
Elm.Slider.make = function (_elm) {
   ...
   var initialModel = function (height) {    return {properties: {topLeft: {x: 10,y: 10},height: height},percentValue: 50};};
   var barPercent = F2(function (mouseInfo,model) {
      var height = $Basics.toFloat(model.properties.height);
      var y = $Basics.toFloat(model.properties.topLeft.y);
   ...
   var mouseDownWithinSlider = F2(function (mouseInfo,model) {
      var height = model.properties.height;
      var y = model.properties.topLeft.y;
      var my = mouseInfo.downPosition.y;
      var x = model.properties.topLeft.x;
   ...
   var modelSignal = A3($Signal.foldp,update,initialModel(200),mouseInfoSignal);
   var renderModel = function (model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.hr,_U.list([]),_U.list([])),$Html.text($Basics.toString(model))]));
   };
   var thumbCSS = _U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid #cccccc"}
                          ,{ctor: "_Tuple2",_0: "background",_1: "#f6f6f6"}
                          ,{ctor: "_Tuple2",_0: "left",_1: "-4px"}
                          ,{ctor: "_Tuple2",_0: "margin-left",_1: "0"}
                          ,{ctor: "_Tuple2",_0: "margin-bottom",_1: "-4px"}
                          ,{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                          ,{ctor: "_Tuple2",_0: "z-index",_1: "2"}
                          ,{ctor: "_Tuple2",_0: "width",_1: "18px"}
                          ,{ctor: "_Tuple2",_0: "height",_1: "18px"}
                          ,{ctor: "_Tuple2",_0: "border-radius",_1: "4px"}]);
   var trackCSS = _U.list([{ctor: "_Tuple2",_0: "width",_1: "12px"}
                          ,{ctor: "_Tuple2",_0: "background",_1: "#eeeeee"}
                          ,{ctor: "_Tuple2",_0: "border-radius",_1: "4px"}
                          ,{ctor: "_Tuple2",_0: "border",_1: "1px solid #dddddd"}
                          ,{ctor: "_Tuple2",_0: "position",_1: "relative"}
                          ,{ctor: "_Tuple2",_0: "margin-left",_1: "10px"}
                          ,{ctor: "_Tuple2",_0: "margin-top",_1: "10px"}]);
   var renderSlider = function (model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(A2($List._op["::"],
      {ctor: "_Tuple2",_0: "height",_1: A2($Basics._op["++"],$Basics.toString(model.properties.height),"px")},
      trackCSS))]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.style(A2($List._op["::"],
      {ctor: "_Tuple2",_0: "bottom",_1: A2($Basics._op["++"],$Basics.toString(model.percentValue),"%")},
      thumbCSS))]),
      _U.list([]))]));
   };
   var view = function (model) {    return A2($Html.div,_U.list([]),_U.list([renderSlider(model),renderModel(model)]));};
   var main = A2($Signal.map,view,modelSignal);
   var Model = F2(function (a,b) {    return {properties: a,percentValue: b};});
