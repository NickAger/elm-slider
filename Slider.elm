...
barPercent mouseY top model =
    let
        offset =
            Maybe.withDefault 0 model.mouseDownOffset

        y =
            toFloat (mouseY + offset)
