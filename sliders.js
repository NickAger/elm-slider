...
var _user$project$Slider$thumbCSS = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'left', _1: '24px'},
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'z-index', _1: '2'},
		{ctor: '_Tuple2', _0: 'width', _1: '26px'},
		{ctor: '_Tuple2', _0: 'height', _1: '54px'},
		{ctor: '_Tuple2', _0: 'background-image', _1: 'url(\'thumb.jpg\')'}
	]);
...
var _user$project$Slider$trackCSS = _elm_lang$core$Native_List.fromArray(
	[
		{
		ctor: '_Tuple2',
		_0: 'width',
		...
		{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		{ctor: '_Tuple2', _0: 'background-image', _1: 'url(\'track.jpg\')'}
	]);
...
var _user$project$Slider$isDragging = function (model) {
	return _elm_community$maybe_extra$Maybe_Extra$isJust(model.mouseDownOffset);
};
...
var _user$project$Slider$updateMain = F3(
	function (msg, model, top) {
		...
		switch (_p0.ctor) {
			case 'DragStart':
				var offset = A3(_user$project$Slider$calculateOffset, _p0._0, top, model);
				return A2(
			...
			case 'DragAt':
				return A2(
					_user$project$Slider$Model,
					A3(_user$project$Slider$barPercent, _p0._0, top, model),
...
var _user$project$Slider$makeDragEnd = function (_p1) {
...
var _user$project$Slider$subscriptions = function (model) {
	return _elm_community$maybe_extra$Maybe_Extra$isJust(model.mouseDownOffset) ? _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$mouse$Mouse$moves(_user$project$Slider$makeDragAt),
				_elm_lang$mouse$Mouse$ups(_user$project$Slider$makeDragEnd)
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Slider$onMouseDown,
							_elm_lang$html$Html_Attributes$style(
							A2(
								_elm_lang$core$List_ops['::'],
								{
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$int, sliderValues))
			}
			]));
};
...
var _user$project$Sliders$subscriptions = function (model) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		A2(_elm_lang$core$List_ops['::'], serverUpdate, subscriptionsList));
};
var _user$project$Sliders$main = {
	main: _elm_lang$html$Html_App$program(
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Sliders'], 'Sliders', typeof _user$project$Sliders$main === 'undefined' ? null : _user$project$Sliders$main);
